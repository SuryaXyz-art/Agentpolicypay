...
import { Archive, Bot, BrainCircuit, LayoutDashboard, ReceiptText, ShieldPlus, WalletCards } from "lucide-react";
...
const links = [
  ...
  { href: "/request-payment", label: "Request Payment", icon: WalletCards },
