...
const features = [
  ...
  {
    title: "Receipts",
    description: "Attach a real 0G Storage root to the executed guarded-vault intent.",
    icon: FileCheck2
  }
];
      ...
      <section className="relative mx-auto grid min-h-[calc(100vh-72px)] max-w-7xl items-center gap-10 px-5 py-14 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:px-10">
        ...
        <div className="grid gap-7">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link className="button secondary" href="/request-payment">
              Request Payment <WalletCards size={18} />
            </Link>
