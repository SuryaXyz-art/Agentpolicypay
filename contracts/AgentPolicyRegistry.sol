...
contract AgentPolicyRegistry {
    ...
    /// @param approvalThreshold Amount above which the vault requires exact owner approval.
    ...
    function createPolicy(
        ...
        _validatePolicyValues(maxPerTx, dailyLimit, approvalThreshold);
    ...
    function _validatePolicyValues(uint256 maxPerTx, uint256 dailyLimit, uint256 approvalThreshold) internal pure {
        if (approvalThreshold == 0 || approvalThreshold > maxPerTx || maxPerTx > dailyLimit) {
